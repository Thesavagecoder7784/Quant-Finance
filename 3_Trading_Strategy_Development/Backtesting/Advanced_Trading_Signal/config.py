...
SLIPPAGE_PERCENTAGE = 0.0005  # 0.05% slippage per trade
MAX_POSITION_PERCENTAGE = 0.2 # Maximum 20% of portfolio value in a single asset
WALK_FORWARD_WINDOWS = 12 # Number of windows for walk-forward optimization
WALK_FORWARD_STEP = 1 # Step size for walk-forward optimization (in months)
